...
public class LearnExcel {
	public static void main(String[] args) throws InvalidFormatException, IOException {
		XSSFWorkbook workbook = new XSSFWorkbook(new File("./data/createleadData.xlsx")); //		1. Using file location, navigate and open the workbook
		...
		int cellCount = worksheet.getRow(0).getLastCellNum();	//		4. Determine the number of cells in the row
